...
class PostHandler {
    ...
    public Mono<ServerResponse> update(ServerRequest req) {
        ...
        return Mono
                .zip(
                        ...
                        this.posts.findById(Integer.valueOf(req.pathVariable("id"))),
    ...
    public Mono<ServerResponse> delete(ServerRequest req) {
        return ServerResponse.noContent().build(this.posts.deleteById(Integer.valueOf(req.pathVariable("id"))));
    }
